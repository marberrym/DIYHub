...
let HomePost = (props) => {
    ...
    <Link to={"/project/" + props.featured.project.id} style={{backgroundPositionY: '90%', backgroundImage: 'url(' + props.featured.project.feature_image_url + ')'}} className="noDec flexC feature alignC justC">
